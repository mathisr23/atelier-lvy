...
export default function Footer() {
  return (
    <footer className="bg-[#2A1506] text-[#FBF5E9] mt-32">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        {/* Nav */}
        <div>
          <p className="font-ui text-xs uppercase tracking-widest text-[#FBF5E9]/40 mb-4">Navigation</p>
        ...
        <div>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-sm text-[#FBF5E9]/70 hover:text-[#F2A0A8] transition-colors"
          >
